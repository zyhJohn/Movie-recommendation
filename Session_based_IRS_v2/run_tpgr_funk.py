...
agent.save_model('./funk_ckpt/1e-3_32/tpgr_LSTM.ckpt')
print('Begin Test')
test_count = 0
result = []
...
pickle.dump(result, open('tpgr_'+matrix_name+'_1e-3_32', mode='wb'))
pickle.dump(loss_list, open('tpgr_'+matrix_name+'_1e-3_32'+'_losslist', mode='wb'))
print('Result:')
