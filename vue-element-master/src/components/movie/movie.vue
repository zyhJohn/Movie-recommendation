	...
	<div class="testProject">
		...
		<div id="table">
			<el-table :data="tableData" stripe style="width: 100%">
				...
				<el-table-column prop="downloadUrl" label="下载地址" width=240>
				</el-table-column>
				<el-table-column prop="introduce" label="介绍" width=280>
				</el-table-column>
				<el-table-column prop="language" label="语种" width=100>
				</el-table-column>
				<el-table-column prop="mainActor" label="主演" width=100>
				</el-table-column>
				<el-table-column prop="movieTime" label="电影时长" width=100>
				</el-table-column>
				<el-table-column prop="publishDate" label="上映日期" width=100>
				</el-table-column>
				<el-table-column label="操作" width=120>
					<template slot-scope="scope">
						<el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.movieId)">修改</el-button>
						<el-button type="text" size="small" @click="deleteHandle(scope.row.movieId)">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination
